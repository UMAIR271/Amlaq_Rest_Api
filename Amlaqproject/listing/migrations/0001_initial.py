    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Amenities_Name', models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Furnishing_type', models.CharField(choices=[('Unfurnished', 'Unfurnished'), ('Semi-furnished', 'Semi-furnished'), ('Furnished', 'Furnished')], max_length=14)),
                ('Property_Tenure', models.CharField(choices=[('FreeHold', 'FreeHold'), ('Non FreeHold', 'Non FreeHold'), ('LeaseHold', 'LeaseHold')], max_length=13)),
                ...
                ('property_Usage', models.CharField(choices=[('Single Family', 'Single Family'), ('Bachelors', 'Bachelors')], max_length=20, null=True)),
